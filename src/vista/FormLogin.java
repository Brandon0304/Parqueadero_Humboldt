...
public class FormLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setForeground(new java.awt.Color(18, 61, 102));
        ...
        JTextField_usuario.setForeground(new java.awt.Color(0, 102, 102));
        ...
        jPanel1.add(JTextField_usuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 170, 240, 30));
        ...
        jPanel1.add(jPasswordField_contraseña, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 230, 240, 30));

        jButton_acceder.setBackground(new java.awt.Color(18, 61, 104));
        ...
        jPanel1.add(jButton_acceder, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 270, 240, 30));

        jPanel3.setBackground(new java.awt.Color(18, 61, 104));

        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("PARQUEADERO VON HUMBOLDT");
        jPanel3.add(jLabel4);

        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 420, 50));

        jPanel5.setBackground(new java.awt.Color(18, 61, 104));

        jLabel6.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/telefono.png"))); // NOI18N
        jLabel6.setText("3229095030");
        jPanel5.add(jLabel6);

        jLabel5.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/ubicacion.png"))); // NOI18N
        jLabel5.setText("Armenia, Quindío");
        jPanel5.add(jLabel5);

        jPanel1.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 380, 420, 80));

        jPanel4.setBackground(new java.awt.Color(0, 0, 0));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("© 2024 Corporación Universitaria Empresarial Alexander Von Humboldt");
        jPanel4.add(jLabel8);

        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 460, 420, 90));
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/parqueadero.png"))); // NOI18N
        jPanel2.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 550, 550));

        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 0, 480, 550));
    ...
    private void IniciarSesion(){
        if(JTextField_usuario.getText().isEmpty() && jPasswordField_contraseña.getText().isEmpty()){
            ...
            if(controlUsuario.login(usuario)){
                ...
                //JOptionPane.showMessageDialog(null, "Inicio sesión con éxito");
